...
e.g. if a machine has 4 cores, then with 4 threads, the speed-up is about 4x.
...
```{r}
# use as many threads as CPUs (may include hyperthreading) (default)
start1 <- proc.time()
ghostbasil(A, r, n.threads=-1) 
end1 <- proc.time()
...
print(paste("Parallel:", end1-start1))
print(paste("Sequential:", end2-start2))
```

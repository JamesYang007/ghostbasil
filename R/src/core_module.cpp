...
RCPP_MODULE(core_module) {
    ...
    Rcpp::class_<BlockGroupGhostMatrixWrap>("BlockGroupGhostMatrix__")
        ...
        .method("to_dense", &BlockGroupGhostMatrixWrap::to_dense_exp)
        .property("get_S", &BlockGroupGhostMatrixWrap::get_S_exp)
        .property("get_D", &BlockGroupGhostMatrixWrap::get_D_exp)
        .property("n_groups", &BlockGroupGhostMatrixWrap::n_groups_exp)
    ...
    Rcpp::class_<BlockBlockGroupGhostMatrixWrap>("BlockBlockGroupGhostMatrix__")
        .constructor<Rcpp::List>()
        .method("col_dot", &BlockBlockGroupGhostMatrixWrap::col_dot_exp)
        .method("quad_form", &BlockBlockGroupGhostMatrixWrap::quad_form_exp)
        .method("to_dense", &BlockBlockGroupGhostMatrixWrap::to_dense_exp)
        .property("matrices", &BlockBlockGroupGhostMatrixWrap::get_mat_list_exp)
        .property("dim", &BlockBlockGroupGhostMatrixWrap::dim_exp)
        ;
}
